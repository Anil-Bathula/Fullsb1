...
Test class     : EmailNotification_user_Test - 86%
...
Modified by prem :SFSUP-SFSUP-1023 (10/04/2015) - Removed Ruth Loftus(ruth.loftus@hult.edu)
*/
trigger EmailNotification_user on User (after insert,after update) {
    ...
    if(boolvar==true){
        ...
        if(!usr.isEmpty()){
            ...
            String str='Dear Salesforce Team'+'\n\n';
            String Subject;
            if(activeuser!=null){
